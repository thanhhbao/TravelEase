        ...
        <tr>
            <td style="padding: 24px 24px 12px;">
                ...
                <p style="margin: 12px 0; color: #4b5563; font-size: 15px;">
                    Thank you for creating an account on <strong>TravelEase</strong>. Use the verification code below to confirm your email address.
                </p>
                ...
                <p style="margin: 12px 0; color: #4b5563; font-size: 15px;">
                    The code expires in {{ $ttlMinutes }} minutes. If you did not request this, you can safely ignore this email.
                </p>
            </td>
        </tr>
        <tr>
